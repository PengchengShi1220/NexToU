# 2022.03.16-Changed for training NexToU with BTI loss on ICA datasets
...
from nnunet.training.network_training.nnUNetTrainerV2_nextou_noMirroring import nnUNetTrainerV2_NexToU_noMirroring


class nnUNetTrainerV2_NexToU_BTI_ICA_noMirroring(nnUNetTrainerV2_NexToU_noMirroring):
    """
