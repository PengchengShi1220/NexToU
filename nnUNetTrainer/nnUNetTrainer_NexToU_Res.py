...
from nnunetv2.training.nnUNetTrainer.variants.network_architecture.NexToU_Res import NexToU_Res
...
class nnUNetTrainer_NexToU_Res(nnUNetTrainer):
    @staticmethod
    def build_network_architecture(plans_manager: PlansManager,
        ...
        segmentation_network_class_name = 'NexToU_Res' #configuration_manager.UNet_class_name
        mapping = {
            'PlainConvUNet': PlainConvUNet,
            'ResidualEncoderUNet': ResidualEncoderUNet,
            'NexToU_Res': NexToU_Res
        }
        kwargs = {
            'PlainConvUNet': {
                'conv_bias': True,
